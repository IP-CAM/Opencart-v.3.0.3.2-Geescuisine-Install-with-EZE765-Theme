...
(function($) {
  ...
  $.fn.WPO_Layout = function(opts, datajson) {
    ...
    function addColumn(scol, row) {
      $(".xl-col", $wpolayout).removeClass("active");
      var col = $('<div class="active xl-col wpo-col">\n\
    ...
    function addRow(srow, sub) {
      var row  = $('<div class="wpo-row xl-row"><div class="wpo-tool"><div class="wpo-sortable ptstooltip" data-placement="top" title="Sort"></div></div><div class="inner clearfix"></div></div>');
    ...
    function cloneLayoutInRow(row, sub, incol) {
      ...
      $(row).children('.inner').children(".xl-col").each(function() {
        ...
        $(cc).css({'width' : (rcd.xlcol / config.col * 100) + '%'});
    ...
    function renderLayoutInRow(rows, widgetids, sub, incol) {
      $(rows).each(function() {
        ...
        $(this.cols).each(function() {
          ...
          $(col).css({'width' : (this.xlcol / config.col * 100) + '%'});
