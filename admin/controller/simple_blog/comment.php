...
class ControllerSimpleBlogComment extends Controller
{
    ...
    public function insert()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validateForm())) {
            ...
            $this->response->redirect($this->url->link('simple_blog/comment', 'user_token=' . $this->session->data['user_token'] . $url, true));
        }
        $this->getForm();
    }
    ...
    public function getList()
    {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href'      => $this->url->link('simple_blog/comment', 'user_token=' . $this->session->data['user_token'] . $url, true),
            'separator' => ' :: '
        );
        $data['insert'] = $this->url->link('simple_blog/comment/insert', 'user_token=' . $this->session->data['user_token'] . $url, true);
        $data['delete'] = $this->url->link('simple_blog/comment/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
        $data['comments'] = array();
        $filter_data = array(
            'sort'                         => $sort,
            'order'                        => $order,
        ...
        foreach ($results as $result) {
            ...
            $data['comments'][] = array(
                ...
                'edit'                   => $this->url->link('simple_blog/comment/update', 'user_token=' . $this->session->data['user_token'] . '&simple_blog_comment_id=' . $result['simple_blog_comment_id'] . $url, true)
            );
        }
        ...
        $data['sort_article_title'] = $this->url->link('simple_blog/comment', 'user_token=' . $this->session->data['user_token'] . '&sort=sbad.article_title' . $url, true);
        $data['sort_author_name'] = $this->url->link('simple_blog/comment', 'user_token=' . $this->session->data['user_token'] . '&sort=sbc.name' . $url, true);
        $data['sort_status'] = $this->url->link('simple_blog/comment', 'user_token=' . $this->session->data['user_token'] . '&sort=sbc.status' . $url, true);
        $data['sort_date_added'] = $this->url->link('simple_blog/comment', 'user_token=' . $this->session->data['user_token'] . '&sort=sbc.date_added' . $url, true);
        $url = '';
        if (isset($this->request->get['sort'])) {
            $url .= '&sort=' . $this->request->get['sort'];
        }
        ...
        $pagination->url = $this->url->link('simple_blog/comment', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
    ...
    public function getForm()
    {
        ...
        if (!isset($this->request->get['simple_blog_comment_id'])) {
            $data['action'] = $this->url->link('simple_blog/comment/insert', 'user_token=' . $this->session->data['user_token'] . $url, true);
        } else {
            $data['action'] = $this->url->link('simple_blog/comment/update', 'user_token=' . $this->session->data['user_token'] . '&simple_blog_comment_id=' . $this->request->get['simple_blog_comment_id'] . $url, true);
        }
        $data['cancel'] = $this->url->link('simple_blog/comment', 'user_token=' . $this->session->data['user_token'] . $url, true);
