<?php
// Heading
$_['heading_title']            = '<span style="background: linear-gradient(to right, #42527b , #00b4ff); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">ZEMEZ</span> Foodleco';
...
$_['entry_label_discount']             = 'Show Percent Sale';
...
$_['help_label_discount']              = 'Show Percent Sale';
