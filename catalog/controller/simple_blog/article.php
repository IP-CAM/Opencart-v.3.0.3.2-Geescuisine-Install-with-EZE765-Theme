...
class ControllerSimpleBlogArticle extends Controller
{
    public function index()
    {
        ...
        if ($this->config->has('theme_' . $this->config->get('config_theme') . '_simple_blog_status')) {
            $data['simple_blog_status'] = $this->config->get('theme_' . $this->config->get('config_theme') . '_simple_blog_status');
        }
        ...
        if ($this->config->has('theme_' . $this->config->get('config_theme') . '_simple_blog_related_articles')) {
            $data['simple_blog_related_articles'] = $this->config->get('theme_' . $this->config->get('config_theme') . '_simple_blog_related_articles');
        }
        if ($this->config->has('theme_' . $this->config->get('config_theme') . '_simple_blog_author_information')) {
            $data['simple_blog_author_information'] = $this->config->get('theme_' . $this->config->get('config_theme') . '_simple_blog_author_information');
        }
        if ($this->config->has('theme_' . $this->config->get('config_theme') . '_simple_blog_share_social_site')) {
        ...
        if ($simple_blog_article_id) {
            ...
            if ($article_info) {
                ...
                foreach ($related_product as $product) {
                    ...
                    $image = ($product_info['image']) ? $this->model_tool_image->resize($product_info['image'], $this->config->get('theme_' . $this->config->get('config_theme') . '_image_related_width'), $this->config->get('theme_' . $this->config->get('config_theme') . '_image_related_width')) : false;
