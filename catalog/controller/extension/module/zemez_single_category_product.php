...
class ControllerExtensionModuleZemezSingleCategoryProduct extends Controller
{
    public function index($setting)
    {
        ...
        if ($setting['category']) {
            $data['category_name'] = $this->model_catalog_category->getCategory($setting['category'])['name'];
        }
        ...
        if (($setting['featured'] == "1" && $setting['tabs'] == "1") || ($setting['type'] == "3" && $setting['tabs'] == "0")) {
            ...
            $products = $setting['product'] ? array_slice($setting['product'], 0, (int)$setting['limit']) : [];
            ...
            foreach ($products as $product_info) {
                ...
                if ($product_info) {
                    ...
                    $productArray[] = array(
                        ...
                        'tax'               => $tax,
                        'rating'            => $rating,
                        'date_end'          => $product_info['date_end'] !== '0000-00-00' ? $product_info['date_end'] : false,
