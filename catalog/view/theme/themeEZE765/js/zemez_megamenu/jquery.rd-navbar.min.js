!function(e) {
  var t, s, a = {cntClass : "rd-mobilemenu", menuClass : "rd-mobilemenu_ul", submenuClass : "rd-mobilemenu_submenu", panelClass : "rd-mobilepanel", toggleClass : "rd-mobilepanel_toggle", titleClass : "rd-mobilepanel_title"}, l = function(t, s) {
  ...
  l.prototype = {
    init                    : function() {
      ...
      var t = this;
      e("body").append(e("<div/>", {"class" : a.cntClass}).append(t.createNavDOM())).append(e("<div/>", {"class" : a.panelClass}).append(e("<button/>", {"class" : a.toggleClass}).append(e("<span/>"))).append(e("<div/>", {"class" : a.titleClass, text : document.title})))
