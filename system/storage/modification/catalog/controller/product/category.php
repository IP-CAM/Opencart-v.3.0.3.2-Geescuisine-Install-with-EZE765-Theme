...
class ControllerProductCategory extends Controller {
	public function index() {
				...
				$this->document->addScript('catalog/view/theme/' . $this->config->get('theme_' . $this->config->get('config_theme') . '_directory') . '/js/ajax_infinite_scroll.js');
		...
		$this->load->model('tool/image');
				...
				$data['text_load_more'] = sprintf($this->language->get('text_load_more'), $this->config->get($this->config->get('config_theme') . '_product_limit'));
